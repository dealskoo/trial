...
@section('title', __('trial::trial.add_trial'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('trial::trial.add_trial') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('trial::trial.add_trial') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('seller.trials.store') }}" method="post">
                        @csrf
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="number" class="form-control" id="ship_fee" name="ship_fee" required
                                           value="{{ old('ship_fee', 0) }}" tabindex="5">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control date" id="activity_date" name="activity_date"
                                       data-toggle="date-picker" value="{{ old('activity_date') }}" required tabindex="6">
                            </div>
                        </div> <!-- end row -->
                        <div class="text-end">
